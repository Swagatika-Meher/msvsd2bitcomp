...
if {[info exist ::env(VDD_CUSTOM_CONNECTION)]} {
  create_custom_connections $::env(VDD_CUSTOM_CONNECTION)
}

if {[info exist ::env(VSS_CUSTOM_CONNECTION)]} {
  create_custom_connections $::env(VSS_CUSTOM_CONNECTION)
}
