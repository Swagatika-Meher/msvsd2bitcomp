...
```
After exporting '.gds' file generated by Align to magic and extract '.spice' file, manually the node 'VDD' in generated netlist by magic are renamed and the postlayout (generated by ALIGN tool) compared with pre-layout testbench inverter schematic.
```
* SPICE3 file created from INVERTER_0.ext - technology: sky130A
