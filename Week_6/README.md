...
```
If we can see carefully, in the above netlist 'TIQ_1', 'TIQ_4' and 'TIQ_6' pins were not reflected in FETs instances. So, manually added these three pins to get the correct plots.
