...
if args.platform == "sky130hd":
    aux1 = "FLASH_ADC_SYM_1"
    aux2 = "FLASH_ADC_SYM_2"
    aux3 = "FLASH_ADC_SYM_3"
    aux4 = "FLASH_ADC_SYM_4"
    aux5 = "FLASH_ADC_SYM_5"
    aux6 = "FLASH_ADC_SYM_6"
    aux7 = "FLASH_ADC_SYM_7"
elif args.platform == "sky130hs":
    aux1 = "FLASH_ADC_SYM_1_hs"
    aux2 = "FLASH_ADC_SYM_2_hs"
    aux3 = "FLASH_ADC_SYM_3_hs"
    aux4 = "FLASH_ADC_SYM_4_hs"
    aux5 = "FLASH_ADC_SYM_5_hs"
    aux6 = "FLASH_ADC_SYM_6_hs"
    aux7 = "FLASH_ADC_SYM_7_hs"

shutil.copyfile(
    srcDir + "FLASH_ADC_SYM_1.v", flowDir + "design/src/flash_adc/FLASH_ADC_SYM_1.v"
)
shutil.copyfile(
    srcDir + "FLASH_ADC_SYM_2.v", flowDir + "design/src/flash_adc/FLASH_ADC_SYM_2.v"
)
shutil.copyfile(
    srcDir + "FLASH_ADC_SYM_3.v", flowDir + "design/src/flash_adc/FLASH_ADC_SYM_3.v"
)
shutil.copyfile(
    srcDir + "FLASH_ADC_SYM_4.v", flowDir + "design/src/flash_adc/FLASH_ADC_SYM_4.v"
)
shutil.copyfile(
    srcDir + "FLASH_ADC_SYM_5.v", flowDir + "design/src/flash_adc/FLASH_ADC_SYM_5.v"
)
shutil.copyfile(
    srcDir + "FLASH_ADC_SYM_6.v", flowDir + "design/src/flash_adc/FLASH_ADC_SYM_6.v"
)
shutil.copyfile(
    srcDir + "FLASH_ADC_SYM_7.v", flowDir + "design/src/flash_adc/FLASH_ADC_SYM_7.v"
)
shutil.copyfile(
    srcDir + "flash_adc.v", flowDir + "design/src/flash_adc/" + designName + ".v"
)
shutil.copyfile(
    srcDir + "priority_encoder.v", flowDir + "design/src/flash_adc/priority_encoder.v"
)
...
#  subprocess.run(["ls", "-l", flowDir, "results/", args.platform, "/flash_adc"])

shutil.copyfile(
    flowDir + "results/" + args.platform + "/flash_adc/6_final.gds",
...
shutil.copyfile(
    flowDir + "results/" + args.platform + "/flash_adc/6_final.v",
    outputDir + "/" + designName + ".v",
)
shutil.copyfile(
    flowDir + "results/" + args.platform + "/flash_adc/6_1_fill.sdc",
...
#)
shutil.copyfile(
    flowDir + "reports/" + args.platform + "/flash_adc/6_final_drc.rpt",
    outputDir + "/6_final_drc.rpt",
)
#shutil.copyfile(
#    flowDir + "reports/" + args.platform + "/flash_adc/6_final_lvs.rpt",
